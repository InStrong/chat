        ...
        try (ServerSocket serverSocket = new ServerSocket(8189)) {
            ...
            while (true) {
                ...
                try {
                    ...
                    MainServer.logger.log(Level.INFO,"Подключился новый клиент");
                } catch (IOException e) {
                    MainServer.logger.log(Level.WARNING,"WARNING! По какой-то причине не удалось создать обработчик клиента");
            ...
            MainServer.logger.log(Level.INFO,"Сервер завершил свою работу");
